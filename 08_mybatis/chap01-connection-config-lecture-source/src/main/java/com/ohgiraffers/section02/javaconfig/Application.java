...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *  ---------------------------------------
         *  PooledDataSource: Connection Pool 활용
         *  UnPooledDataSource: Connection Pool 활용 X
        * */
        ...
        configuration.addMapper(Mapper.class);  // 인터페이스를 주면 알아서 하위 구현체를 만듬
        ...
        * */
        ...
        java.util.Date nowDate = mapper.selectNo();
