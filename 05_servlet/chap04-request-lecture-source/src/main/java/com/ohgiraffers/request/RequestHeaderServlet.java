...
//        super.doGet(req, resp);
         ...
         *   2. Request Header
         *      : 패치 될 리소스나 클라이언트 자체에 대한 상세 정보를 포함하는 헤더이다. (수정 되어야 할 리소스)
         *   3. Response Header
         *      : 요청 위치나 서버 응답에 대한 부가적인 정보를 갖는 헤더이다. (성공/실패, 어떻게 성공, 어떻게 응담, ...)
         *   4. Entity Header
         *      : 컨텐츠 길이나 MIME 타입과 같은 엔티티 바디에 대한 상세 정보를 포함하는 헤더이다.(MIME: 인터넷 표준 타입, 프론트 관련은 MDN 사이트가 가장 정석)
