...
public class Application1 {
    ...
    /* 설명. 문자열에서 한줄식 읽어올 수 있는 BufferedReader를 반환하는 수업용 별도의 메소드 */
    ...
    public static Integer solution(String input) throws IOException {
        ...
        /* 설명. 방문배열(simple path(단순 겨올)를 위한 것이지만 실제로는 stack over flow 방지 목적) */
...
//            System.out.println(start + "번 컴퓨터와 연결된 " + i + "번 컴퓨터 방문 전 visit 배열: " + Arrays.toString(visit));
