...
public class ExceptionHandlerController {
    ...
    public String userExceptionTest() throws MemberRegistException {
        ...
        if(true) throw new MemberRegistException("당신은 안되요!");
    ...
    public String userExceptionHandlerTest() throws MemberRegistException {
        if(true) throw new MemberRegistException("당신은 안된다니까");

        return "test";
    }

    @ExceptionHandler(MemberRegistException.class)
    public String memberRegistExceptionHandler(Model model) {
