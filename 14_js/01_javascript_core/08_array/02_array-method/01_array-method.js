...
console.log(`chickenList.unshift(): ${chickenList.unshift('프라닭')}`);
...
console.log(`idol1을 기준으로 idol2 배열 concat: ${[...idol1, ...idol2]}`);
console.log(...idol1);  // 배열의 요소를 나열해주는 것(스프레드 연산자(...))
